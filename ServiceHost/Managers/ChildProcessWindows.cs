...
public class ChildProcessWindows : IDisposable
{
    ...
    public bool AddProcess(System.Diagnostics.Process p_Process)
    {
        return AddProcess(p_Process.Handle);
    }
}
